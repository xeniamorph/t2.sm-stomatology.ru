...
class AbstractSitemapTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function itShouldThrowExceptionIfFilePathDoesNotExist()
    {
        $this->setExpectedException(
            $this->exception,
            'Provided path \ SITE_TEMPLATE_PATH.'img/do/not/exist\' does not exist or is not writable.'
        );
        new DummyAbstractSitemap( SITE_TEMPLATE_PATH.'img/do/not/exist', $this->sitemapFile, false);
    }
