...
namespace App\Bundle\Vars\Infoblock;
use TAO\Infoblock;

class Vars extends Infoblock
{
    ...
    {
        return array(
            'LIST_PAGE_URL' => '#SITE_DIR#/settings/index.php?ID=#IBLOCK_ID#',
            'DETAIL_PAGE_URL' => '#SITE_DIR#/settings/detail.php?ID=#ELEMENT_ID#',
            'SECTION_PAGE_URL' => '#SITE_DIR#/settings/list.php?SECTION_ID=#SECTION_ID#',
            'INDEX_SECTION' => 'Y',
            'WORKFLOW' => 'N',
