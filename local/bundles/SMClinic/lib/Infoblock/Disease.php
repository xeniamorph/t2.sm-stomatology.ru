...
class Disease extends Infoblock
{
    ...
    {
        return array(
            'LIST_PAGE_URL' => '#SITE_DIR#/patients/diseases/',
            'DETAIL_PAGE_URL' => '#SITE_DIR#/patients/diseases/#ELEMENT_CODE#/',
            'WORKFLOW' => 'N',
        );
    }
