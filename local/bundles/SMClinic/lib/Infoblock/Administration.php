...
class Administration extends Infoblock
{
    public function title()
    {
        return 'Вопросы к руководителю СКП';
    }
    ...
    {
        return array(
            'LIST_PAGE_URL' => '#SITE_DIR#/feedback/index.php?ID=#IBLOCK_ID#',
            'DETAIL_PAGE_URL' => '#SITE_DIR#/feedback/detail.php?ID=#ELEMENT_ID#',
            'SECTION_PAGE_URL' => '#SITE_DIR#/feedback/list.php?SECTION_ID=#SECTION_ID#',
            'INDEX_SECTION' => 'Y',
            'WORKFLOW' => 'N',
