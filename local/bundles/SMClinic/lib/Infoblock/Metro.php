...
class Metro extends Infoblock
{
    ...
    {
        return array(
            'LIST_PAGE_URL' => '#SITE_DIR#/clinic/index.php?ID=#IBLOCK_ID#',
            'DETAIL_PAGE_URL' => '#SITE_DIR#/clinic/detail.php?ID=#ELEMENT_ID#',
            'SECTION_PAGE_URL' => '#SITE_DIR#/clinic/list.php?SECTION_ID=#SECTION_ID#',
            'INDEX_SECTION' => 'Y',
            'WORKFLOW' => 'N',
