...
class Technologies extends Infoblock
{
    public function title()
    {
        return 'Технологии и оборудование';
    }
...
';
    ...
    {
        return array(
            'LIST_PAGE_URL' => '#SITE_DIR#/about/technologies/',
            'DETAIL_PAGE_URL' => '#SITE_DIR#/about/technologies/#ELEMENT_CODE#/',
            'SECTION_PAGE_URL' => '#SITE_DIR#/about/technologies/',
            'INDEX_SECTION' => 'Y',
            'WORKFLOW' => 'N',
    ...
    public function properties()
    {
        return array(
			...
			'SHOW_LAB' => array(
				'NAME' => 'Выводить на стр. лаборатории',
				'PROPERTY_TYPE' => 'L',
				'LIST_TYPE' => 'C',
				'ITEMS' => array(
					'54d7b418359256b16356ffb0b61a5378' => 'Y',
				),
			),
        );
    }
