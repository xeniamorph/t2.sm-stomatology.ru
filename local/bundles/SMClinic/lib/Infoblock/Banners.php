...
class Banners extends Infoblock
{
    ...
    {
        return array(
            'LIST_PAGE_URL' => '#SITE_DIR#/main_page/index.php?ID=#IBLOCK_ID#',
            'DETAIL_PAGE_URL' => '#SITE_DIR#/main_page/detail.php?ID=#ELEMENT_ID#',
            'SECTION_PAGE_URL' => '#SITE_DIR#/main_page/list.php?SECTION_ID=#SECTION_ID#',
            'INDEX_SECTION' => 'Y',
            'WORKFLOW' => 'N',
    ...
    public function properties()
    {
        return array(
            ...
            'add_block' => array(
                'NAME' => 'Доп поле для ссылок и кнопок',
                'DEFAULT_VALUE' => array(
                    'TEXT' => '',
                    'TYPE' => 'HTML',
                ),
