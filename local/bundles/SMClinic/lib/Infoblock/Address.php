...
class Address extends Infoblock
{
    ...
    public function properties()
    {
        return array(
            ...
            'public_transport' => array(
                'NAME' => 'Проезд общественным транспортом',
                'DEFAULT_VALUE' => array(
                    'TYPE' => 'HTML',
                    'TEXT' => '',
                ),
            ...
            'personal_transport' => array(
                'NAME' => 'Проезд на автомобиле',
                'DEFAULT_VALUE' => array(
                    'TYPE' => 'HTML',
                    'TEXT' => '',
                ),
			...
			'childrens' => array(
				...
				'LIST_TYPE' => 'C',
				'ITEMS' => array(
					'54d7b418359256b16356ffb0b61a5389' => 'Y',
				),
			),
			'credit' => array(
				'NAME' => 'Где можно оформить кредит',
				'PROPERTY_TYPE' => 'E',
				'MULTIPLE' => 'Y',
				'LINK_IBLOCK_CODE' => 'credit',
			),
        );
    }
}
