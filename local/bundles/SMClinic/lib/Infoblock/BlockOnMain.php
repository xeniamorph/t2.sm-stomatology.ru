...
class BlockOnMain extends Infoblock
{
    public function title()
    {
        return 'Блок на главной "О нас"';
    }
    ...
    {
        return array(
            'LIST_PAGE_URL' => '#SITE_DIR#/info/index.php?ID=#IBLOCK_ID#',
...
public function properties()
    ...
    return array(
                'HTML_TITLE' => array(
                    'NAME' => 'Форматированный заголовок',
                    'DEFAULT_VALUE' => array(
                        'TEXT' => '',
                        'TYPE' => 'HTML',
                    ),
