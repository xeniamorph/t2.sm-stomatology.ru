...
?>
<?php $APPLICATION->IncludeComponent("sm:text", ".default", ['IBLOCK_ID' => 23,'ELEMENT_ID' => 14737], false); ?>

<?= \TAO::Form('Lab')->setOption('layout', 'popup-lab')->setOption('title', 'Полный съемный протез')->render(); ?>
