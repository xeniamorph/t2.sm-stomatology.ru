...
<script type="text/javascript">
	...
	$('.mainform_box .time_mainform').click(function() {
		$('.mainform_box .time_dropbox_mainform').show();
	});
	$('.mainform_box .time_dropbox_mainform div').click(function() {
		//console.log($(this).data('value'));
		$('.mainform_box .time_mainform').val($(this).data('value'));
	});
	$(document).mouseup(function (e){
		var time_mainform = $('.mainform_box .time_mainform');
		var time_dropbox_mainform = $('.mainform_box .time_dropbox_mainform');
		if (!time_mainform.is(e.target) &&
			time_mainform.has(e.target).length === 0) {
			$('.mainform_box .time_dropbox_mainform').hide();
		}
	});
	...
	$('.mainform_box #mainform').submit(function(){
		...
		var time = $('.mainform_box .time_mainform').val();
