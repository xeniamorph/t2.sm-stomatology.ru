...
if(!empty($f_phone)) {
    ...
    $items = array(
        ...
        'DATE_BEGIN' => $date,
        'PHONE' => $f_phone,
        'VOPROS' => 'Записаться на бесплатную консультацию имплантолога',
        'SOURCES' => $f_source
    );
    ...
    $email = '';
    $subject = 'sm-stomatology.ru: Форма "Записаться на бесплатную консультацию имплантолога"';

    $message = '
    <html>
        <head>
            <title>Форма "Записаться на бесплатную консультацию имплантолога". Cайт sm-stomatology.ru</title>
        </head>
        <body>
    ...
    $headers .= "To: sm-admin@smpost.ru, ice_splash@mail.ru\r\n";
